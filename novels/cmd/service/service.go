...
import (
	...
	grpc "github.com/moecasts/microcasts/novels/pkg/grpc"
...
var fs = flag.NewFlagSet("novels", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("novels", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
